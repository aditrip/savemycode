...
public class SearchResponse extends ESResponse implements
        JsonResponseObjectMapper<SearchResponse> {
    ...
    public SearchResponse timed_out(boolean timed_out) {
        this.timed_out = timed_out;
        return this;
    }
    ...
    public SearchResponse shardInfo(ShardInfo shardInfo) {
    ...
    public static class Hits extends ESResponse implements
            JsonResponseObjectMapper<Hits> {
        ...
        public Hits max_score(float max_score) {
            this.max_score = max_score;
            return this;
        }
        ...
        public Hits hitItems(List<HitItem> hitItems) {
            this.hitItems = hitItems;
            return this;
        }
        ...
        public Hits buildFromJson(JsonParser parser) throws IOException {
            ...
            while ((token = parser.nextToken()) != JsonToken.END_OBJECT) {
                ...
                if (token.isScalarValue()) {
                    ...
                    JsonUtil.validateToken(JsonToken.START_ARRAY, token,
                                           parser);
        ...
        public static class HitItem extends ESResponse implements
                JsonResponseObjectMapper<HitItem> {
            ...
            public HitItem index(String index) {
                this.index = index;
                return this;
            }
            ...
            public HitItem type(String type) {
                this.type = type;
                return this;
            }
            ...
            public HitItem score(float score) {
                this.score = score;
                return this;
            }
            ...
            public HitItem sourceFields(Map<String, SourceField> sourceFields) {
            ...
            public HitItem sourceAsMap(Map<String, Object> sourceAsMap) {
            ...
            public HitItem source(byte[] source) {
                this.source = source;
                return this;
            }
            ...
            @Override
            public HitItem buildFromJson(JsonParser parser) throws IOException {
                JsonToken token = parser.currentToken();
                JsonUtil.validateToken(JsonToken.START_OBJECT, token, parser);
                token = parser.nextToken();
                JsonUtil.validateToken(JsonToken.FIELD_NAME, token, parser);
                    ...
                    if (token == JsonToken.FIELD_NAME) {
                        ...
                        if (SOURCE.equals(currentFieldName)) {
                            ...
                            while (parser.nextToken() != JsonToken.END_OBJECT) {
                                JsonUtil.validateToken(JsonToken.FIELD_NAME,
                                                       parser.currentToken(),
                                                       parser);
                                JsonUtil.validateToken(JsonToken.START_ARRAY,
                                                       parser.nextToken(),
                                                       parser);
                                SourceField srcField = new SourceField(
                                ...
                                while (parser.nextToken() != JsonToken.END_ARRAY) {
                                    srcField.values()
                                            .add(JsonUtil.objectValue(parser));
                                }
                            }
                        }
                    }
