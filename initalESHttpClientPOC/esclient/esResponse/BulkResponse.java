...
public class BulkResponse extends ESResponse implements
    ...
    private List<BulkItemResponse> itemResponses = new ArrayList<BulkItemResponse>();
    ...
    public BulkResponse tookInMillis(long tookInMillis) {
        this.tookInMillis = tookInMillis;
        return this;
    }
    ...
    public BulkResponse itemResponses(List<BulkItemResponse> itemResponses) {
        this.itemResponses = itemResponses;
        return this;
    }
    ...
    // Since bulk request uses Synchronous response listener - the onComplete method will only be invoked in one thread.
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder();
                ...
                builder.append(" items:[" + itemResponses.subList(0, toIndex) + "]" );
