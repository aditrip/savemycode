        ...
        while((token = parser.nextToken()) != JsonToken.END_OBJECT) {
            ...
            if(token == JsonToken.FIELD_NAME) {
                ...
                if(CLUSTER_NAME.equals(currentFieldName)) {
                    ...
                    clusterHealthStatus = ClusterHealthStatus.fromString(status);
                ...
                }else if (TASK_MAX_WAIT_TIME_IN_QUEUE_IN_MILLIS.equals(currentFieldName)) {
                    taskMaxWaitingTime = parser.getLongValue();
                }else if (ACTIVE_SHARDS_PERCENT.equals(currentFieldName)) {
