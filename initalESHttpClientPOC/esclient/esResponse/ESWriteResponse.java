...
public abstract class ESWriteResponse extends ESResponse {
    ...
    public enum Result {
        ...
        public static Result get(Byte code) throws IOException{
            switch(code){
                case 0:
                    return CREATED;
                case 1:
    ...
    public ESWriteResponse(String index, String type, String id, long seqNo, long version, Result result, RestStatus restStatus) {
        this.index = index;
        this.type = type;
        this.id = id;
        this.seqNo = seqNo;
    ...
    public ESWriteResponse index(String index) {
		this.index = index;
		return this;
	}
    
    public ESWriteResponse id(String id) {
		this.id = id;
		return this;
	}
    
    public ESWriteResponse type(String type) {
		this.type = type;
		return this;
	}
    

	public ESWriteResponse version(long version) {
		this.version = version;
		return this;
	}

	public ESWriteResponse seqNo(long seqNo) {
		this.seqNo = seqNo;
		return this;
	}
    ...
    public ESWriteResponse shardInfo(ShardInfo shardInfo) {
        this.shardInfo = shardInfo;
        return this;
    }
    
    public ESWriteResponse forcedRefresh(boolean forcedRefresh) {
    ...
    /**
     * This is restStatus of this request.
     * TODO: see if rest status of a request is equivalent to 
     * http response status code.
     * Otherwise this needs to be evaluated from Shard's rest status.
     * 
     */
    ...
    /** 
     * This will return OK only when all replicas were successful.
     * This status needs to be used for consistency constrained
     * indexing operation.
     * For operations that do not care about consistency,
     * use restStatus which is set directly by ESRestClient
	...
	public void successfulResponse(boolean successfulResponse) {
		this.successfulResponse = successfulResponse;
	}

	protected static void buildFromJson(JsonParser parser, ESWriteResponse responseObject) throws IOException {
        ...
        if (token.isScalarValue()) {
            if (_INDEX.equals(currentFieldName)) {
            	...
            	new InvalidResponseException("Unknown Field: " + currentFieldName + " at:" + parser.getTokenLocation());
            }
        	...
        	throw new IOException (new InvalidResponseException("Unknown Token: " + token + " at:" + parser.getTokenLocation()));
        }
    }
