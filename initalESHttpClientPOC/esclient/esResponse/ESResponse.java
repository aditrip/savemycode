...
public class ESResponse {
    ...
    /*
     * When the response is not parsed fully, but the 
     * response object is good enough for consumption,
     * buildFromJson method can return the object
     * without marking parsed true.
     * 
     * An example could be bulk items.
     * It might not be required to parse it fully.
     * 
     */
    ...
    /**
     * Replica Info - Informs about total no of replicas this operation was carried out,
     * and successful ones. And failures at replica.
     *
     */
    public static class ShardInfo implements JsonResponseObjectMapper<ShardInfo>{
       ...
       private List<ReplicaFailure> failures = new ArrayList<ReplicaFailure>();

       public ShardInfo() {
       }

       public ShardInfo(int total, int successful, int failed, List<ReplicaFailure> failures) throws InvalidResponseException {
       ...
       public ShardInfo total(int total) {
                       this.total = total;
                       return this;
               }

               public ShardInfo successful(int successful) {
                       this.successful = successful;
                       return this;
               }
               
               public ShardInfo failed(int failed) {
                       this.failed = failed;
                       return this;
               }

               public ShardInfo failures(List<ReplicaFailure> failures) {
                       this.failures = failures;
                       return this;
               }

       /**
        * Total no of shards write request was executed on.
        * It is possible that this number is greater than total no of shards,
        * as it is possible to send write request to both primary and replica of a shard.
        * @return
        */
       public int total() {
           return total;
       ...
       /**
        * @return TODO: check what are these failures we get in the rest API response.
        */
       public int failed() {
        ...
        *       by the ESRestClient. But then that status does not offer 
        *       control on shard level responses. Some replicas might 
        *       have failed to replicate the mutation.
        *       
           ...
           while ((token = parser.nextToken()) != JsonToken.END_OBJECT) {
               if (token == JsonToken.FIELD_NAME) {
                   ...
                   if (FAILURES.equals(currentFieldName)) {
                       ...
                       throw new IOException (new InvalidResponseException("Unknown Field: " + currentFieldName + " at:" + parser.getTokenLocation()));
                   }
               }
           }
       ...
       /**
        * This is a failure structure for a particular shardId on
        * a particular nodeid.
        * 
       ...
       public static class ReplicaFailure implements JsonResponseObjectMapper<ReplicaFailure> {
           ...
           public ReplicaFailure(ShardId  shardId, String nodeId, String cause, RestStatus status, boolean primary) {
           ...
           public ReplicaFailure primary(boolean primary) {
                               this.primary = primary;
                               return this;
                       }
                       ...
                       public ReplicaFailure nodeId(String nodeId) {
                               this.nodeId = nodeId;
                               return this;
                       }

                       public ReplicaFailure cause(String cause) {
                               this.cause = cause;
                               return this;
                       }

                       public ReplicaFailure status(RestStatus status) {
                               this.status = status;
                               return this;
                       }
           ...
           /**
            * If the replica is primary, return true.
            * This means failure occurred on primary replica.
            * This is not a possible case for FTS client operations
            * but Rest Response has it, so parse it.
            */
           ...
           @Override
           public ReplicaFailure buildFromJson(JsonParser parser) throws IOException {
               JsonToken token = parser.currentToken();
               JsonUtil.validateToken(JsonToken.START_OBJECT, token, parser);
               String index = null;
               ...
               return this;
                       ...
                       @Override
                       public ReplicaFailure buildFromRestResponse(RestResponse restResp) {
                               // TODO Auto-generated method stub
                               return null;
                       }
   ...
   static class ShardId implements Comparable<ShardId> {
       ...
       /*
        * This method is called when response is not parseable by
        * the FTS DMLClient code.
        * However the rest response is successful.
        * So an empty response is needed and no exception to be thrown.
        */
