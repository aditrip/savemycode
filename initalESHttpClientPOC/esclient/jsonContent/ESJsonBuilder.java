...
/**
 * This is a wrapper over JsonGenerator.
 * It is a limited one catering to FTS use cases.
 * 
 * It uses the more concrete class of ByteArrayOutputStream,
 * instead of OutputStream used for JsonGenerator.
 * 
 * Also provides some convenience methods for write map type
 * of values.
 * 
 */
public class ESJsonBuilder {
	...
	public ESJsonBuilder(ByteArrayOutputStream bos) throws IOException {
		this.bos = bos;
		this.jsonGen = JsonUtil.createGenerator(bos);
	}
	...
	public ESJsonBuilder field(String fieldName)
			throws IOException {	
		if(fieldName == null ) {
