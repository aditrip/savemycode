...
public enum RestStatus {
    ...
    public static RestStatus status(int successfulShards, int totalShards, ESWriteResponse.ShardInfo.ReplicaFailure... failures) {
        ...
        if (successfulShards == 0 && totalShards > 0) {
            for (ESWriteResponse.ShardInfo.ReplicaFailure failure : failures) {
