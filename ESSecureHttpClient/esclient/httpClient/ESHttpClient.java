...
public class ESHttpClient {
    ...
    public void executeAsync(
        ...
        try {
            ...
            final URI uri = buildUri(pathPrefix, endpoint, requestParams);
            final HttpRequestBase request =
                createHttpRequest(method, uri, entity);
                       ...
                       new FutureCallback<HttpResponse>() {
                           ...
                           private void retryRequestWithTimeout(
                               ...
                               if (timeout <= 0) {
                                   ...
                                   executeAsync(startTime, request,
                                                listener, attempt + 1);
                               }
                           }
    ...
    private static URI buildUri(
        ...
        try {
            ...
            final URIBuilder uriBuilder = new URIBuilder(fullPath);
